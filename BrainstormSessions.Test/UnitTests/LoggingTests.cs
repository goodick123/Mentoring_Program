...
namespace BrainstormSessions.Test.UnitTests
{
    public class LoggingTests : IDisposable
    {
        ...
        public async Task HomeController_Index_LogInfoMessages()
        {
            ...
            var controller = new HomeController(mockRepo.Object, new Mock<ILogger>().Object);
        ...
        public async Task IdeasController_CreateActionResult_LogErrorMessage_WhenModelStateIsInvalid()
        {
            // Arrange & Act
            var mockRepo = new Mock<IBrainstormSessionRepository>();
            var controller = new IdeasController(mockRepo.Object, new Mock<ILogger<IdeasController>>().Object);
        ...
        public async Task SessionController_Index_LogDebugMessages()
        {
            ...
            var controller = new SessionController(mockRepo.Object, new Mock<ILogger<SessionController>>().Object);
