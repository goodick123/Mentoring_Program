...
namespace DataLayerTests
{
    public class BaseRepositoryTests
    {
        ...
        public void ExecuteConnectedQueryWithParams_ShouldOpenConnectionAndExecuteQueryWithParams()
        {
            ...
            baseRepo.ExecuteConnectedQueryWithParams("123", new Dictionary<string, object>()).RunSynchronously();
        ...
        public void ExecuteConnectedQueryWithParams_ShouldOpenConnectionAndExecuteQueryWithParams_ParsedDictionary()
        {
            ...
            commandMock.Setup(c => c.Parameters).Returns(It.IsAny<SqlParameterCollection>());
            ...
            baseRepo.ExecuteConnectedQueryWithParams("INSERT INTO Table Value=@Value WHERE Id=@Id",
                new Dictionary<string, object>() { { "Id", 0 }, { "Value", 123 } }).RunSynchronously();
        ...
        public void ShouldReturnCorrectResult()
        {
            ...
            mockCommand.Setup(c => c.Parameters).Returns(It.IsAny<SqlParameterCollection>());
            mockCommand.Setup(c => c.Parameters.Add(It.IsAny<SqlParameter>()));
            ...
            var result = repository.ConvertExecutedProcedureWithParamsToModel("TestProcedure", parameters).Result;
